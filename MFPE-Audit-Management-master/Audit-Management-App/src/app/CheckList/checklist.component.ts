...
export class ChecklistComponent implements OnInit {
  ...
  // }
  myFunction() : void{
    this.message = "Please check all the answers to submit!!";
  if (this.checklistService.validated(this.questions) && confirm("Are you sure?")) {
    this.checklistService.validated(this.questions);
    this.checklistService.getResponse(this.questions);
    this.securityService.turnOffSpecialFlag();
    this.message = "";
   this.router.navigate(['severity']);
